...
const createuserbutom = document.getElementById("CreateUserForm");
createuserbutom.addEventListener("submit", (e)=>{
    e.preventDefault();
    console.log(app);
    console.log("yaqss");
});
async function getCities(db1) {
    const citiesCol = collection(db1, 'cities');
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["d5kvp","igcvL"], "igcvL", "parcelRequire8da1")

//# sourceMappingURL=loguin.5baa4167.js.map
